 ...
 */
final class Version20250523115957 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE question_v2 (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(50) NOT NULL, content VARCHAR(255) NOT NULL, is_root_question TINYINT(1) NOT NULL, is_quick_question TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE routine_v2 (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(50) NOT NULL, description VARCHAR(255) DEFAULT NULL, days LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', task_time TIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
